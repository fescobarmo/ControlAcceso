...
-- Sistema de Control de Acceso - ControlAcceso
-- =====================================================
-- 
...
-- 6. Espera a que se ejecute (puede tardar 10-30 segundos)
-- 7. Verifica que no haya errores en la consola
--
-- IMPORTANTE:
-- - Este script es idempotente (puedes ejecutarlo múltiples veces)
-- - Crea todas las tablas, índices, triggers, funciones y datos iniciales
...
-- Extensión para encriptación (opcional pero recomendada)
...
-- Tabla: perfiles
-- Descripción: Perfiles de permisos para usuarios
...
-- Tabla: areas
-- Descripción: Áreas físicas del sistema
...
-- Tabla: dispositivos
-- Descripción: Dispositivos de control de acceso
...
-- Descripción: Permisos de acceso de usuarios a áreas
...
-- Tabla: residentes
-- Descripción: Residentes del sistema
...
-- =====================================================
-- PASO 6: DATOS INICIALES - PERFILES
-- =====================================================
...
-- =====================================================
-- PASO 7: DATOS INICIALES - USUARIO ADMINISTRADOR
-- =====================================================
...
-- =====================================================
-- PASO 9: DATOS INICIALES - DISPOSITIVOS
-- =====================================================
...
-- =====================================================
-- PASO 10: DATOS INICIALES - CONFIGURACIÓN
-- =====================================================
...
-- Vista de usuarios completos con información de rol y perfil
...
-- Vista de accesos recientes (últimos 7 días)
...
WHERE u.is_active = true AND (pa.is_active = true OR pa.id IS NULL);

-- =====================================================
-- PASO 12: FUNCIONES ÚTILES
-- =====================================================
...
-- Función: Verificar acceso de usuario a un área
...
-- Función: Estadísticas de usuarios por rol
...
-- 
-- PRÓXIMOS PASOS:
-- 1. Verifica las tablas en la sección "Table Editor" de Supabase
-- 2. Revisa los datos iniciales
...
-- 
-- Ver usuario admin:
-- SELECT id, username, email, estado FROM usuarios WHERE username = 'admin';
-- 
